...
O historiador não pode confiar nas opiniões e descrições dos senhores de escravos
...
no início do século \versal{XX}. Durante o século \versal{XIX}, alguns homens e mulheres
...
Unidos e se tornaram famosas. Mas
%Ana-Lancman: substituir o "mas" por outro conector?
as narrativas do século \versal{XX} representam
...
haviam vivido sob esta instituição. Seus projetos eram pequenos, mas
...
estados resumiram suas conversas com ex"-cativos e enviaram quase 2400
...
para os emancipados. Na década seguinte ao conflito, os homens
...
humilhante em locais públicos e serviços governamentais, que conquistou o selo de aprovação da Suprema Corte dos
...
%Ana-Lancman: Achei que o último parágrafo está mal formulado, mas não consegui pensar em uma substituição.
\footnote{Para %%ao falar?
...
pessoas brancas. Caso ofendessem um branco, nada, nem mesmo sua idade avançada, poderia protegê"-los de consequências desagradáveis.
...
mundo e reconheciam o fato 
%Ana-Lancman: Apagar "o fato?"
e as regras da subordinação racial.
...
%Ana-Lancman: Pouquíssimas pessoas?
tiveram a coragem de condenar a crueldade ou a
...
coerção e falta de liberdade. Por exemplo, um comentário típico de um
...
descrição mais sombria das realidades
%Ana-Lancman: Repetiu informação, não sei se é proposital.
do cativeiro do que os
...
de idade em 1865. Portanto, não é surpresa que as experiências pessoais de
...
Quando examinamos o local em que os entrevistados haviam vivenciado a escravidão,
...
aqueles nos limites
%Ana-Lancman: no limite?
do Sul não dominam o conjunto.
...
As atitudes dos historiadores em relação às Narrativas de
Escravos do \versal{FWP} mudaram junto com a sociedade americana, e também com as
conquistas do Movimento dos Direitos Civis, o que culminou na adoção do
ponto de vista do professor Woodward por parte dos estudiosos.
%Ana-Lancman: Não sei se "culminou" é uma boa palavra.
Em 1972, o professor John Blassingame publicou \emph{The Slave Community} {[}A Comunidade
Escrava{]}, um livro que soube usar muito bem as narrativas
...
se refugiar e expandir. Hoje, é consenso que os escravizados do Sul
...
presente e que promete continuar no futuro.
...
ideias nos
%Ana-Lancman: Seria "nas quais"?
quais estes estão inseridos. Ao adaptar as leis e os
...
Os cativos encontravam o racismo por parte dos brancos no seu cotidiano e eram
...
Genovese, dão menos importância ao paternalismo e enxergam uma
...
coleção das memórias de ex"-escravizados, teríamos uma quantidade menor de material com que
...
valiosa, praticamente única, sobre como era a vida em cativeiro no
...
um tema que esclarece
%Ana-Lancman: O termo esclarece poderia ser substituído por outro, como "revela", por conta da crítica recente do pensamento decolonial.
um aspecto importante da escravidão. Os oito são:
Trabalho, Condições de vida, Crueldade e castigos físicos, Famílias,
Atitudes raciais, Cultura negra, Resistência e Emancipação.

A extensão e o tom das entrevistas sofreram algum nível de
...
completo de uma entrevista razoavelmente típica com um ex"-escravizado.
%Ana-Lancman: Não entendi o "razoavelmente típica".
Como veremos, muitas das passagens reunidas aqui não se concentram
...
informações importantes sobre as realidades econômicas e sociais e as
